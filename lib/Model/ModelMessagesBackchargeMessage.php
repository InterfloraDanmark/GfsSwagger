...
/**
 * ModelMessagesBackchargeMessage Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelMessagesBackchargeMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model.Messages.BackchargeMessage';
    ...
    protected static $swaggerFormats = [
        'backcharge_id' => 'int32',
        'amount' => 'double',
        'backcharge_type' => 'int32',
        'backcharge_state' => 'int32',
        'reason' => null,
    ...
    protected static $attributeMap = [
        ...
        'amount' => 'Amount',
        'backcharge_type' => 'BackchargeType',
        'backcharge_state' => 'BackchargeState',
        'reason' => 'Reason',
    ...
    protected static $setters = [
        ...
        'amount' => 'setAmount',
        'backcharge_type' => 'setBackchargeType',
        'backcharge_state' => 'setBackchargeState',
        'reason' => 'setReason',
    ...
    protected static $getters = [
        ...
        'amount' => 'getAmount',
        'backcharge_type' => 'getBackchargeType',
        'backcharge_state' => 'getBackchargeState',
        'reason' => 'getReason',
    ...
    const BACKCHARGE_TYPE_0 = 0;
    const BACKCHARGE_TYPE_1 = 1;
    const BACKCHARGE_STATE_1 = 1;
    const BACKCHARGE_STATE_2 = 2;
    const BACKCHARGE_STATE_3 = 3;
    const BACKCHARGE_STATE_4 = 4;
     ...
     * @return string[]
     */
    public function getBackchargeTypeAllowableValues()
    {
        return [
            self::BACKCHARGE_TYPE_0,
            self::BACKCHARGE_TYPE_1,
        ];
    }
     ...
     * @return string[]
     */
    public function getBackchargeStateAllowableValues()
    {
        return [
            self::BACKCHARGE_STATE_1,
            self::BACKCHARGE_STATE_2,
            self::BACKCHARGE_STATE_3,
            self::BACKCHARGE_STATE_4,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['backcharge_type'] = isset($data['backcharge_type']) ? $data['backcharge_type'] : null;
        $this->container['backcharge_state'] = isset($data['backcharge_state']) ? $data['backcharge_state'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBackchargeTypeAllowableValues();
        if (!is_null($this->container['backcharge_type']) && !in_array($this->container['backcharge_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'backcharge_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getBackchargeStateAllowableValues();
        if (!is_null($this->container['backcharge_state']) && !in_array($this->container['backcharge_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'backcharge_state', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    /**
     * Gets backcharge_type
     *
     * @return int
     */
    public function getBackchargeType()
    {
        return $this->container['backcharge_type'];
    }

    /**
     * Sets backcharge_type
     *
     * @param int $backcharge_type backcharge_type
     *
     * @return $this
     */
    public function setBackchargeType($backcharge_type)
    {
        $allowedValues = $this->getBackchargeTypeAllowableValues();
        if (!is_null($backcharge_type) && !in_array($backcharge_type, $allowedValues, true)) {
        ...
        $this->container['backcharge_type'] = $backcharge_type;

        return $this;
    }

    /**
     * Gets backcharge_state
     *
     * @return int
     */
    public function getBackchargeState()
    {
        return $this->container['backcharge_state'];
    }

    /**
     * Sets backcharge_state
     *
     * @param int $backcharge_state backcharge_state
     *
     * @return $this
     */
    public function setBackchargeState($backcharge_state)
    {
        $allowedValues = $this->getBackchargeStateAllowableValues();
        if (!is_null($backcharge_state) && !in_array($backcharge_state, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'backcharge_state', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['backcharge_state'] = $backcharge_state;
