...
/**
 * ModelMessagesQueryMessage Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelMessagesQueryMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model.Messages.QueryMessage';
    ...
    protected static $swaggerTypes = [
        'subject' => 'string',
        'text' => 'string',
        'query_message_type' => 'int',
        'query_fields' => '\Swagger\Client\Model\ModelMessagesQueryField[]',
        'url' => 'string',
    ...
    protected static $attributeMap = [
        'subject' => 'Subject',
        'text' => 'Text',
        'query_message_type' => 'QueryMessageType',
    ...
    protected static $setters = [
        'subject' => 'setSubject',
        'text' => 'setText',
        'query_message_type' => 'setQueryMessageType',
        'query_fields' => 'setQueryFields',
        'url' => 'setUrl',
        'waiting_for_response' => 'setWaitingForResponse',
        'id' => 'setId',
    ...
    protected static $getters = [
        'subject' => 'getSubject',
        'text' => 'getText',
        'query_message_type' => 'getQueryMessageType',
        'query_fields' => 'getQueryFields',
        'url' => 'getUrl',
        'waiting_for_response' => 'getWaitingForResponse',
        'id' => 'getId',
    ...
    const QUERY_MESSAGE_TYPE_1 = 1;
    const QUERY_MESSAGE_TYPE_2 = 2;
    const QUERY_MESSAGE_TYPE_3 = 3;
    const QUERY_MESSAGE_TYPE_4 = 4;
     ...
     * @return string[]
     */
    public function getQueryMessageTypeAllowableValues()
    {
        return [
            self::QUERY_MESSAGE_TYPE_1,
            self::QUERY_MESSAGE_TYPE_2,
            self::QUERY_MESSAGE_TYPE_3,
            self::QUERY_MESSAGE_TYPE_4,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['query_message_type'] = isset($data['query_message_type']) ? $data['query_message_type'] : null;
        $this->container['query_fields'] = isset($data['query_fields']) ? $data['query_fields'] : null;
        $this->container['url'] = isset($data['url']) ? $data['url'] : null;
        $this->container['waiting_for_response'] = isset($data['waiting_for_response']) ? $data['waiting_for_response'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getQueryMessageTypeAllowableValues();
        if (!is_null($this->container['query_message_type']) && !in_array($this->container['query_message_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'query_message_type', must be one of '%s'",
    ...
    /**
     * Gets query_message_type
     *
     * @return int
     */
    public function getQueryMessageType()
    {
        return $this->container['query_message_type'];
    }

    /**
     * Sets query_message_type
     *
     * @param int $query_message_type query_message_type
     *
     * @return $this
     */
    public function setQueryMessageType($query_message_type)
    {
        $allowedValues = $this->getQueryMessageTypeAllowableValues();
        if (!is_null($query_message_type) && !in_array($query_message_type, $allowedValues, true)) {
        ...
        $this->container['query_message_type'] = $query_message_type;
     ...
     * Gets query_fields
     *
     * @return \Swagger\Client\Model\ModelMessagesQueryField[]
     */
     ...
     * Sets query_fields
     *
     * @param \Swagger\Client\Model\ModelMessagesQueryField[] $query_fields query_fields
     *
     * @return $this
     */
    ...
    /**
     * Gets waiting_for_response
     *
     * @return bool
     */
    public function getWaitingForResponse()
    {
        return $this->container['waiting_for_response'];
    }

    /**
     * Sets waiting_for_response
     *
     * @param bool $waiting_for_response waiting_for_response
     *
     * @return $this
     */
    public function setWaitingForResponse($waiting_for_response)
    {
        $this->container['waiting_for_response'] = $waiting_for_response;
