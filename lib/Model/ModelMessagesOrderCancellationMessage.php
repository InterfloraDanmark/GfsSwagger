...
/**
 * ModelMessagesOrderCancellationMessage Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelMessagesOrderCancellationMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model.Messages.OrderCancellationMessage';
    ...
    protected static $swaggerFormats = [
        ...
        'text' => null,
        'closing_info' => null,
        'backcharge_to_unit_amount' => 'int32',
        'id' => 'int32',
    ...
    protected static $attributeMap = [
        ...
        'backcharge_to_unit_amount' => 'BackchargeToUnitAmount',
        'id' => 'Id',
    ...
    protected static $setters = [
        'reason' => 'setReason',
        'text' => 'setText',
        'closing_info' => 'setClosingInfo',
        'backcharge_to_unit_amount' => 'setBackchargeToUnitAmount',
        'id' => 'setId',
    ...
    protected static $getters = [
        'reason' => 'getReason',
        'text' => 'getText',
        'closing_info' => 'getClosingInfo',
        'backcharge_to_unit_amount' => 'getBackchargeToUnitAmount',
        'id' => 'getId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['closing_info'] = isset($data['closing_info']) ? $data['closing_info'] : null;
        $this->container['backcharge_to_unit_amount'] = isset($data['backcharge_to_unit_amount']) ? $data['backcharge_to_unit_amount'] : null;
    ...
    {
        return $this->container['closing_info'];
    }

    /**
     * Sets closing_info
     *
     * @param bool $closing_info closing_info
     *
     * @return $this
     */
    public function setClosingInfo($closing_info)
    {
        $this->container['closing_info'] = $closing_info;

        return $this;
    }

    /**
     * Gets backcharge_to_unit_amount
     *
     * @return int
     */
    public function getBackchargeToUnitAmount()
    {
        return $this->container['backcharge_to_unit_amount'];
    }

    /**
     * Sets backcharge_to_unit_amount
     *
     * @param int $backcharge_to_unit_amount backcharge_to_unit_amount
     *
     * @return $this
     */
    public function setBackchargeToUnitAmount($backcharge_to_unit_amount)
    {
        $this->container['backcharge_to_unit_amount'] = $backcharge_to_unit_amount;
