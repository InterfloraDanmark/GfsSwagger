...
/**
 * ModelMessagesDeliveryConfirmedMessage Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelMessagesDeliveryConfirmedMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model.Messages.DeliveryConfirmedMessage';
    ...
    const DELIVERY_METHOD_1 = 1;
    const DELIVERY_METHOD_2 = 2;
    const DELIVERY_METHOD_3 = 3;
    const DELIVERY_METHOD_4 = 4;
    const DELIVERY_METHOD_5 = 5;
    const DELIVERY_METHOD_6 = 6;
    const DELIVERY_METHOD_7 = 7;
    const DELIVERED_BY_1 = 1;
    const DELIVERED_BY_2 = 2;
    const DELIVERED_BY_3 = 3;
    ...
    {
        return [
            self::DELIVERY_METHOD_1,
            self::DELIVERY_METHOD_2,
            self::DELIVERY_METHOD_3,
            self::DELIVERY_METHOD_4,
            self::DELIVERY_METHOD_5,
            self::DELIVERY_METHOD_6,
            self::DELIVERY_METHOD_7,
        ];
    }
     ...
     * @return string[]
     */
    public function getDeliveredByAllowableValues()
    {
        return [
            self::DELIVERED_BY_1,
            self::DELIVERED_BY_2,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDeliveredByAllowableValues();
        if (!is_null($this->container['delivered_by']) && !in_array($this->container['delivered_by'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'delivered_by', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param int $delivery_method delivery_method
     *
     * @return $this
     */
     ...
     * Sets delivered_by
     *
     * @param int $delivered_by delivered_by
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDeliveredByAllowableValues();
        if (!is_null($delivered_by) && !in_array($delivered_by, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'delivered_by', must be one of '%s'",
                    implode("', '", $allowedValues)
