...
class UnitApi
{
    ...
    {
        list($response) = $this->unitGetAllWithHttpInfo();
        return $response;
    }
     ...
     */
    public function unitGetAllWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Unit[]';
        $request = $this->unitGetAllRequest();
     ...
     */
    public function unitGetAllAsync()
    {
        return $this->unitGetAllAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unitGetAllAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Unit[]';
        $request = $this->unitGetAllRequest();
