...
class ProductApi
{
    ...
    {
        list($response) = $this->productGetAllWithHttpInfo();
        return $response;
    }
     ...
     */
    public function productGetAllWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Product[]';
        $request = $this->productGetAllRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetAllAsync()
    {
        return $this->productGetAllAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetAllAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Product[]';
        $request = $this->productGetAllRequest();
     ...
     * @return \Swagger\Client\Model\Product[]
     */
    public function productGetByCountry($country_code)
    {
        list($response) = $this->productGetByCountryWithHttpInfo($country_code);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Product[], HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetByCountryWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\Product[]';
        $request = $this->productGetByCountryRequest($country_code);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetByCountryAsync($country_code)
    {
        return $this->productGetByCountryAsyncWithHttpInfo($country_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetByCountryAsyncWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\Product[]';
        $request = $this->productGetByCountryRequest($country_code);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productGetByCountryRequest($country_code)
    {
     ...
     *
     * @param  \Swagger\Client\Model\Product $product A new or existing product (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Product
